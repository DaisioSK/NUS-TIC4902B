...
data = pd.read_csv('Tripcom/tripcom_clean_review.csv', encoding='utf_8_sig', index_col=False)
...
def display_topics(model, feature_names, num_top_words):
    ...
    for topic_idx, topic in enumerate(model.components_):
        ...
        topics[topic_key] = [feature_names[i] for i in topic.argsort()[:-num_top_words - 1:-1]]
    return topics
...
# Present the topics in a structured list format
